...
function RideStarted(props) {
    ...
    return ( 
        ...
        <div className="flex flex-col justify-between items-center bg-white p-2">
                ...
                <button className='w-full mt-2 rounded-xl bg-green-600 text-white p-2' onClick={()=>{props.setConfirmPayment(true); props.setRideStarted(false)} }>Make Payment</button>
            </div>
