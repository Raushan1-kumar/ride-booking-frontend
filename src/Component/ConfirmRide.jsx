function ConfirmRide(props) {
    ...
    return (
        <>
            <div className="flex flex-col justify-between w-full mt-10 items-center bg-white p-2">

                <h2 className='text-xl font-bold w-full  mt-2 mb-8'>Confirm this ride to Start</h2>
                <div className="flex flex-row mb-2 justify-between border-4 border-yellow-500 rounded-xl w-full">
                ...
                <div className='flex flex-row w-full py-2 h-17 items-center'>
                    ...
                    <div className="flex flex-col">
                        <h1 className="font-bold text-xl mx-2 pt-1 pb-1">634/11-B</h1>
