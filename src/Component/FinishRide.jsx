    ...
    return (
        <>
            <div className="flex flex-col justify-between w-full items-center bg-white p-2">
                <h1 className='text-xl font-bold w-full  mt-2 mb-4'>Finish this Ride</h1>
                <div className="flex flex-row mb-2 justify-between bg-yellow-400 rounded-xl w-full">
                    <div className="flex flex-row  items-center">
                        ...
                        <div className=" flex justify-center items-center">
                            <h1 className="text-xl font-bold ml-2">Harsh Rajput</h1>
                        </div>
                    </div>
                ...
                <div className='flex flex-row w-full h-12 py-2 my-2 items-center'>
                ...
                <div className='flex flex-row w-full py-2 h-17 items-center'>
                    ...
                    <div className="flex flex-col">
                        <h1 className="font-bold text-xl mx-2 pt-1 pb-1">675/23-B </h1>
                ...
                <div className='flex flex-row w-full py-2 h-17 items-center'>
                    ...
                    <div>
                        ...
                        <p className="mx-2 pt-1 font-medium text-base text-gray-500"></p>
                    </div>
                </div>
            </div>
        </>
